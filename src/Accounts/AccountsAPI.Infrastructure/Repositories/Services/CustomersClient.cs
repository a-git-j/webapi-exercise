...
namespace AccountsAPI.Infrastructure.Services.Customers
{
    ...
    public partial class CustomersClient 
    {
        ...
        /// <summary>Gets information about existing customer</summary>
        /// <param name="customerId">Customer identifier</param>
        /// <exception cref="SwaggerCustomerClientException">A server side error occurred.</exception>
        /// <exception cref="SwaggerCustomerClientException{System.Exception}">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<CustomerViewModel> GetAsync(int customerId)
        {
        ...
        /// <exception cref="SwaggerCustomerClientException">A server side error occurred.</exception>
        /// <exception cref="SwaggerCustomerClientException{System.Exception}">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<CustomerViewModel> GetAsync(int customerId, System.Threading.CancellationToken cancellationToken)
        {
            if (customerId == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<CustomerViewModel>(response_, headers_).ConfigureAwait(false);
                        ...
                        if (status_ == "400") 
                        {
                            ...
                            throw new SwaggerCustomerClientException("A server side error occurred.", (int)response_.StatusCode, objectResponse_.Text, headers_, responseObject_);
                        }
                        else
                        if (status_ != "200" && status_ != "204")
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false); 
                            throw new SwaggerCustomerClientException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", (int)response_.StatusCode, responseData_, headers_, null);
                        }
            
                        return default(CustomerViewModel);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        protected virtual async System.Threading.Tasks.Task<ObjectResponseResult<T>> ReadObjectResponseAsync<T>(System.Net.Http.HttpResponseMessage response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                catch (Newtonsoft.Json.JsonException exception)
                {
                    ...
                    throw new SwaggerCustomerClientException(message, (int)response.StatusCode, responseText, headers, exception);
                }
            }
            else
            {
                ...
                catch (Newtonsoft.Json.JsonException exception)
                {
                    ...
                    throw new SwaggerCustomerClientException(message, (int)response.StatusCode, string.Empty, headers, exception);
                }
            }
        }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.0.4.0 (NJsonSchema v10.0.21.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class SwaggerCustomerClientException : System.Exception
    {
        ...
        public SwaggerCustomerClientException(string message, int statusCode, string response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers, System.Exception innerException) 
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.0.4.0 (NJsonSchema v10.0.21.0 (Newtonsoft.Json v11.0.0.0))")]
    public partial class SwaggerCustomerClientException<TResult> : SwaggerCustomerClientException
    {
        public TResult Result { get; private set; }

        public SwaggerCustomerClientException(string message, int statusCode, string response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers, TResult result, System.Exception innerException) 
